...
sealed class Tree<out A : Comparable<@UnsafeVariance A>> {
    ...
    internal object Empty : Tree<Nothing>() {
        ...
        override fun rotateRight(): Tree<Nothing> = TODO("rotateRight")

        override fun rotateLeft(): Tree<Nothing> = TODO("rotateLeft")
    ...
    internal class T<out A : Comparable<@UnsafeVariance A>>(internal val left: Tree<A>,
        ...
        override fun rotateRight(): Tree<A> = TODO("rotateRight")

        override fun rotateLeft(): Tree<A> = TODO("rotateLeft")
