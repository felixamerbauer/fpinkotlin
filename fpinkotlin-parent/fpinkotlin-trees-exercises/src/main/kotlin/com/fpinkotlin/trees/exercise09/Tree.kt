...
sealed class Tree<out A : Comparable<@UnsafeVariance A>> {
    ...
    internal object Empty : Tree<Nothing>() {
        ...
        override fun <B> foldInOrder(identity: B, f: (B) -> (Nothing) -> (B) -> B): B = TODO("foldInOrder")

        override fun <B> foldPreOrder(identity: B, f: (Nothing) -> (B) -> (B) -> B): B = TODO("foldPreOrder")

        override fun <B> foldPostOrder(identity: B, f: (B) -> (B) -> (Nothing) -> B): B = TODO("foldPostOrder")
    ...
    internal class T<out A : Comparable<@UnsafeVariance A>>(internal val left: Tree<A>,
        ...
        override fun <B> foldInOrder(identity: B, f: (B) -> (A) -> (B) -> B): B = TODO("foldInOrder")

        override fun <B> foldPreOrder(identity: B, f: (A) -> (B) -> (B) -> B): B = TODO("foldPreOrder")

        override fun <B> foldPostOrder(identity: B, f: (B) -> (B) -> (A) -> B): B = TODO("foldPostOrder")
